...
all_data, all_times = load_all_quadruples('{}'.format(args.dataset), 'train.txt', 'valid.txt', "test.txt")
# all_data, all_times = load_all_quadruples('../data/{}'.format(args.dataset), 'train.txt', "test.txt")
train_data, train_times = load_quadruples('{}'.format(args.dataset), 'train.txt')
num_e, num_r = get_total_number('{}'.format(args.dataset), 'stat.txt')
