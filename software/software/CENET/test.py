    ...
    for batch_data in utils.make_batch(data,
        ...
        if args.path:
            if args.dataset.lower() == 'icews21':
                ...
                rel_path_idx = (max_train_t - (max_train_t // 6) * 6) * batch_data[0][:, 0] * num_nodes + batch_data[0][:, 2]
        ...
        with torch.no_grad():
            ...
            sub_rank3, obj_rank3, cur_loss3, ce_all_acc = model(batch_data, 'Test', total_data, rel_path_vocabulary=one_hot_rel_path)
